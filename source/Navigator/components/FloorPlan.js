...
function RoomFloorPlan({
  ...
  React.useEffect(() => {
    ...
    fetch(pianoItem.geoJsonUrl).then(r => r.json()).then(d => setGeoJson(d)).catch(() => {});
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }), geoJson && /*#__PURE__*/React.createElement("svg", {
    ...
    if (amenity) {
      return /*#__PURE__*/React.createElement("polygon", {
        ...
        points: points,
        className: "geo-amenity-polygon"
      }, /*#__PURE__*/React.createElement("title", null, amenity.label));
    }
    return /*#__PURE__*/React.createElement("polygon", {
      key: f.properties.fid,
      points: points,
  ...
  })), geoJson && !selectedRoom && /*#__PURE__*/React.createElement("p", {
    className: "geo-map-hint"
  }, "Tocca una stanza per vedere le opere"), geoJson && (() => {
    const presentIds = [...new Set(geoJson.features.map(f => f.properties.room_id))].filter(id => AMENITY_ICONS[id]);
    if (!presentIds.length) return null;
    return /*#__PURE__*/React.createElement("div", {
      className: "geo-amenity-legend"
    }, presentIds.map(id => /*#__PURE__*/React.createElement("span", {
      key: id,
      className: "geo-amenity-legend-item"
    }, /*#__PURE__*/React.createElement("span", {
      className: "geo-amenity-legend-icon"
    }, /*#__PURE__*/React.createElement("i", {
      className: `fa-solid ${AMENITY_ICONS[id].icon}`
    })), AMENITY_ICONS[id].label)));
  })(), selectedRoom && /*#__PURE__*/React.createElement("div", {
    className: "geo-room-panel"
  }, /*#__PURE__*/React.createElement("div", {
    className: "geo-room-panel-header"
  }, /*#__PURE__*/React.createElement("span", {
    className: "geo-room-panel-title"
  }, roomDisplayName(selectedRoom)), /*#__PURE__*/React.createElement("button", {
    className: "geo-room-panel-close",
    onClick: () => {
      setSelectedRoom(null);
      setRoomOpere(null);
    }
  }, "✕")), loadingOpere && /*#__PURE__*/React.createElement("div", {
    className: "geo-room-loading"
  }, /*#__PURE__*/React.createElement("div", {
    className: "geo-spin-sm"
  }), /*#__PURE__*/React.createElement("span", null, "Caricamento opere…")), roomOpere && roomOpere.length === 0 && /*#__PURE__*/React.createElement("p", {
    className: "geo-room-empty"
  }, "Nessuna opera disponibile per questa sala."), roomOpere && roomOpere.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "geo-opera-list"
  }, roomOpere.map(o => /*#__PURE__*/React.createElement("div", {
    key: o._id,
    className: "geo-opera-card"
  }, o.immagine && /*#__PURE__*/React.createElement("img", {
    loading: "lazy",
    className: "geo-opera-img",
    src: o.immagine,
    alt: o.operaId
  }), /*#__PURE__*/React.createElement("div", {
    className: "geo-opera-body"
  }, /*#__PURE__*/React.createElement("p", {
    className: "geo-opera-title"
  }, o.operaId), o.autore && /*#__PURE__*/React.createElement("p", {
    className: "geo-opera-meta"
  }, o.autore, o.datazione ? ` · ${o.datazione}` : ''), o.tipo && /*#__PURE__*/React.createElement("p", {
    className: "geo-opera-tipo"
  }, o.tipo), o.descrizione && /*#__PURE__*/React.createElement("p", {
    className: "geo-opera-desc"
  }, o.descrizione)))))));
}
function VisitaItemRoomMap({
  museumId,
  operaId,
  logisticsTarget = null
}) {
  ...
  React.useEffect(() => {
    ...
    (async () => {
      try {
        const [rMuseo, rOpere] = await Promise.all([fetch(`/api/musei/${encodeURIComponent(museumId)}`).then(r => r.json()), operaId ? fetch(`/api/opere?codiceIsil=${encodeURIComponent(museumId)}`).then(r => r.json()) : Promise.resolve({
          data: []
        })]);
        if (cancelled) return;
        ...
        if (!cancelled && fallbackPiano) {
          setFloorDef(fallbackPiano);
          setGeoJson(fallbackGeo);
        }
      } catch (_) {} finally {
  ...
  if (!floorDef || !geoJson) return /*#__PURE__*/React.createElement("p", {
    style: {
      textAlign: 'center',
      color: 'var(--nav-muted)',
      fontSize: '0.85rem',
  ...
  const legendIds = [...new Set(geoJson.features.map(f => f.properties.room_id))].filter(id => AMENITY_ICONS[id]);
  return /*#__PURE__*/React.createElement("div", {
    className: "visita-item-map"
  }, /*#__PURE__*/React.createElement("p", {
    className: "visita-item-map-title"
  }, /*#__PURE__*/React.createElement("i", {
    className: "fa-solid fa-map-location-dot",
    style: {
      marginRight: '6px'
    }
  }), logisticsTarget ? /*#__PURE__*/React.createElement(React.Fragment, null, "Stai cercando: ", AMENITY_ICONS[logisticsTarget.roomId]?.label || 'Punto di interesse') : sala != null ? /*#__PURE__*/React.createElement(React.Fragment, null, "Ti trovi in: ", roomDisplayName(String(sala))) : /*#__PURE__*/React.createElement(React.Fragment, null, "Planimetria museo")), /*#__PURE__*/React.createElement("div", {
    className: "geo-floorplan-wrap"
  }, /*#__PURE__*/React.createElement("img", {
    loading: "lazy",
    className: "geo-floorplan-img",
    src: floorDef.url,
    alt: floorDef.piano || 'Planimetria'
  ...
  })), legendIds.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "geo-amenity-legend"
  }, legendIds.map(id => /*#__PURE__*/React.createElement("span", {
    key: id,
    className: "geo-amenity-legend-item"
  }, /*#__PURE__*/React.createElement("span", {
    className: "geo-amenity-legend-icon"
