/* FloorPlan.jsx - AMENITY_ICONS, TEMP_EXHIBIT_ID, roomDisplayName, ringCentroid, RoomFloorPlan, VisitaItemRoomMap */
  ...
  React.useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Cerca il piano che contiene la sala; fallback al primo piano con geoJson
